function [CM_v,S,aw_v,ae_v,as_v,an_v,ap_v,d_v,d_v_sec] = COEFFV(V_old,P,...
...
%     change values for An As Ae Aw Ap and RHS.
    ...
    d_v_sec(I_solid(i),J_solid(i))=0;  %% I Changed Here
